<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="PlanesCapacitacionEmpresa.aspx.cs" Inherits="Seguridad.Web.Capacitaciones.PlanesCapacitacionEmpresa" %>
...
<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Planes Capaitación Empresa</h2>
