<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="AltasMedicas.aspx.cs" Inherits="Seguridad.Web.Accidentabilidad.AltasMedicas" %>

<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="row" style="margin-top:-25px !important">
      <div class="panel panel-default">
            <h3 class="page-head-title">Altas Médicas</h3>
            ...
            <div id="listarUsuarios" class="tab-pane active cont">
              <table>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                    <asp:Button runat="server" CssClass="btn btn-space btn-default" Text="Limpiar" id="btnLimpiar"></asp:Button>
                  </td>
                </tr>
              </table>
              <br/>
                    ...
                    <form>
                      <table class="table">
                        ...
                        <tr>
                          <td></td>
                          <td>
                            <asp:Button runat="server" id="btnGuardar" CssClass="btn btn-primary" Text="Guardar"></asp:Button>
                          </td>
                        </tr>
                      </table>
                    </form>
