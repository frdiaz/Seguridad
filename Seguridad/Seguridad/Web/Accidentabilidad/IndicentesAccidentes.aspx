<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="IndicentesAccidentes.aspx.cs" Inherits="Seguridad.Web.Accidentabilidad.IndicentesAccidentes" %>

<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Indicentes / Accidentes</h2>
