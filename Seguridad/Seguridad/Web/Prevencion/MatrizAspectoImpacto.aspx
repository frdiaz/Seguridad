<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="MatrizAspectoImpacto.aspx.cs" Inherits="Seguridad.Web.Prevencion.MatrizAspectoImpacto" %>

<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Matriz Aspecto / Impacto</h2>
