<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="MatrizPeligroImpacto.aspx.cs" Inherits="Seguridad.Web.Prevencion.MatrizPeligroImpacto" %>

<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Matriz Peligro / Impacto</h2>
