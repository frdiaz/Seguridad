<%@ Page Language="C#" MasterPageFile="../Control/MasterPage.master" AutoEventWireup="true" CodeBehind="ProgramaCapacitacion.aspx.cs" Inherits="Seguridad.Web.Prevencion.ProgramaCapacitacion" %>

<asp:Content id="Content2" ContentPlaceHolderID="contentPlaceHolder1" runat="server">
    <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Programa de Capacitación</h2>
